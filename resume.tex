...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed packages for internal \textbf{Wally} registry, reducing development time by 30\%, by leveraging reusibility.}
        \resumeItem{Contributed to the development of M.O.M. HQ written in \textbf{Luau}, reaching 20k+ visits in early open beta.}
        \resumeItem{Implemented CI/CD pipelines for packages, utilitzed for 10+ packages, fully automating package publishing}
      \resumeItemListEnd
...
\section{Extracurriculars}
    \resumeSubHeadingListStart
      ...
      \resumeItemListStart
        ...
        \resumeItemListEnd
      \resumeProjectHeading
        {\textbf{ByteNet} $|$ \emph{Luau, Networking}}{Jan. 2025}
        \resumeItemListStart
